...
namespace TF.GUI
{
    partial class MainForm
    {
        ...
        private void CreateNewTranslation()
        {
...
#else
                    MessageBox.Show($"The {workFolder} folder is not empty. Select an empty folder.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    return;
#endif
                }
            }
            ...
            var workForm = new WorkingForm(dockTheme, "New Translation Project");
            ...
            workForm.DoWork += (sender, args) =>
            {
                ...
                {
                    args.Cancel = true;
                    worker.ReportProgress(-1, "Removing files...");
                    PathHelper.DeleteDirectory(workFolder);
                    worker.ReportProgress(-1, "Finished");
                }
#if !DEBUG
        ...
        private void LoadTranslation()
        {
            ...
            if (dialogResult == DialogResult.OK)
            {
                ...
                var workForm = new WorkingForm(dockTheme, "Load Translation Project", true);
                ...
                if (_currentFile != null)
                {
                    if (_currentFile.NeedSaving)
                    {
                        var result = MessageBox.Show(
                            "It is recommended to save changes before proceeding.\nWould you like to save?",
        ...
        private void SearchInFiles()
        {
            if (_project != null)
            {
                ...
                var workForm = new WorkingForm(dockTheme, "Search files", true);
        ...
        private void ExportTexts()
        {
            if (_project != null)
            {
                ...
                FolderBrowserDialog.Description = "Select a folder where the files will be saved.";
                ...
                var workForm = new WorkingForm(dockTheme, "Export");
        ...
        private void ExportImages()
        {
            if (_project != null)
            {
                ...
                FolderBrowserDialog.Description = "Select the folder where images will be stored.";
                FolderBrowserDialog.ShowNewFolderButton = true;
        ...
        private void ImportTexts()
        {
            if (_project != null)
            {
                ...
                FolderBrowserDialog.Description = "Select";
